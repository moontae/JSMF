...
function BATCH_createVD(input_folder, output_folder, min_objects, min_tokens, T)
    ...
    Ks = [5, 10, 15, 20, 25, 50, 75, 100, 125, 150, 200, 250, 300];
    Ksets = {Ks(1:8), Ks(1:8), Ks(1:8), Ks(1:end), Ks(1:8), Ks(1:11)};           
        
    datasets = {'nytimes', 'movies', 'songs'};
    Nsets = {[30000, 60000], ...
             [1250, 2500, 5000, 10000], ...
             [5000, 10000, 20000, 40000]};               
    Ks = [5, 10, 15, 20, 25, 50, 75, 100, 125, 150];
    Ksets = {Ks(1:end), Ks(1:8), Ks(1:8)};       
    ...
    for i = 1:length(datasets)        
        ...
        for N = Nset
            logger.info('  + Reading and parsing with N=%d...', dataset, N);
